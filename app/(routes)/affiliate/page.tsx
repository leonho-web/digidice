	...
	if (!user) {
		return (
			<div className="min-h-screen bg-background">
				<ClientSEO
					title="Affiliate Program - Earn Commissions | DigiDice"
					description="Join the DigiDice affiliate program and earn up to 50% commission on player wagers. Track referrals, bonuses, and claim rewards."
					keywords="affiliate program digidice, casino affiliate, betting commissions, referral rewards, earn money online, digidice"
