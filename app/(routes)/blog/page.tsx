...
export const metadata = {
    title: 'Blog | DigiDice - Strategies, Tips & Platform Updates',
    description: 'Discover expert betting strategies, platform updates, and winning tips from the DigiDice team. Stay ahead of the game with our latest insights.',
}
            ...
            <div className="relative overflow-hidden border-b bg-gradient-to-br from-background via-primary/5 to-background py-24">
                ...
                <div className="container relative mx-auto px-4 text-center">
                    ...
                    <h1 className="mb-6 text-5xl font-extrabold tracking-tight sm:text-7xl">
                        The <span className="text-primary">Digi</span>Blog
                    </h1>
                    <p className="mx-auto mb-10 max-w-2xl text-xl text-muted-foreground">
                        Discover the latest game strategies, platform updates, and community stories.
                    ...
                    <div className="flex items-center justify-center gap-8 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-muted-foreground">Expert Tips</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-20">
                {posts.length > 0 ? (
                                ...
                                <div className="flex items-center gap-1">
                                    {Array.from({ length: Math.ceil(total / 9) }, (_, i) => (
                                        <Button
                                            ...
                                            asChild
                                        >
                                            <Link href={`/blog?page=${i + 1}${search ? `&search=${search}` : ''}`}>
                                                {i + 1}
                                            </Link>
                                        </Button>
                                    ))}
                                </div>
                                <Button variant="outline" size="sm" disabled={page >= Math.ceil(total / 9)}>
                                    Next
                                </Button>
                            </div>
                        )}
                    ...
                    <div className="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <p className="text-muted-foreground mb-4">Try adjusting your search terms or browse all posts.</p>
                        <Button asChild>
            ...
            <div className="border-t bg-muted/20 py-16">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                        Get the latest strategies, tips, and platform updates delivered straight to your inbox.
                    </p>
