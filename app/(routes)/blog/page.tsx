...
export async function generateMetadata(): Promise<Metadata> {
	...
	return generateSEOMetadata({
		...
		path: "/blog",
		pageType: "blog",
		ogTitle: `Blog | ${siteName} - Strategies, Tips & Platform Updates`,
		ogDescription: `Discover expert betting strategies, platform updates, and winning tips from the ${siteName} team. Stay ahead of the game with our latest insights.`,
		ogType: "website",
		ogUrl: `${siteDomain}/blog`,
