...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (slug.length === 1) {
    ...
    return generateSEOMetadata({
      title: `${providerName} Games - Play Online Casino Games - DigiDice`,
      description: `Explore all ${providerName} games on DigiDice. Play slots, live casino, and more from ${providerName} with amazing features and big wins.`,
    ...
    return generateSEOMetadata({
      title: `${providerName} ${categoryName} Games - DigiDice`,
      description: `Play ${categoryName} games from ${providerName} on DigiDice. Enjoy the best ${categoryName} gaming experience with top features and rewards.`,
  ...
  // Fallback
  return generateSEOMetadata({
    title: 'Games - DigiDice',
    description: 'Explore all games on DigiDice',
