...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return generateSEOMetadata({
    title: `${categoryName} Game Providers - DigiDice`,
    description: `Discover the best ${categoryName} game providers on DigiDice. Play games from top providers with exciting features and big wins.`,
