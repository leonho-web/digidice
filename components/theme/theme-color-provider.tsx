...
export type ThemeColor = "casino" | "red" | "rose" | "orange" | "green" | "blue" | "yellow" | "violet" | "poker" | "poker-vibrant" | "midnight-ocean" | "rudish-vibrant";
...
export function ThemeColorProvider({ children, defaultTheme = "green", storageKey = "ui-theme-color", ...props }: ThemeColorProviderProps) {
  ...
  useEffect(() => {
    ...
    root.classList.remove("theme-casino", "theme-red", "theme-rose", "theme-orange", "theme-green", "theme-blue", "theme-yellow", "theme-violet", "theme-poker", "theme-poker-vibrant");
